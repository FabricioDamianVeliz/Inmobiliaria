...
<html>
    ...
    <body>
        ...
        <div id="show-clientes" class="content scaffold-show" role="main">
            ...
            <f:display bean="clientes" />
            <g:form resource="${this.clientes}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.clientes}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
