        ...
        <div id="show-contrato" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.contrato}" method="DELETE">
                <fieldset class="buttons">
                    ...
                    <g:link class="save" controller='administracion' action="estadoPropiedad" id="${this.contrato.propiedad.id}">Finalizar Contrato</g:link>
                    <input class="save" type="button" value="Imprimir Contrato" onclick="window.print()" >
                </fieldset>
            </g:form>
        </div>
    </body>
