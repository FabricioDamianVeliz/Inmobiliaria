        ...
        <div id="show-vendedor" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.vendedor}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.vendedor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                    <input class="delete" type="submit" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />

                    <g:link class="save" action="createPropiedad" resource="${this.vendedor}">Crear Propiedad</g:link>
                </fieldset>
            </g:form>
        </div>
    </body>
